...
class UrlsTests(TestCase):
    def test_resolves_book_list_view(self):
    ...
    def test_resolves_book_create_view(self):
    ...
    def test_resolves_book_update_view(self):
        book_id = 1
    ...
    def test_resolves_fetch_view(self):
    ...
    def test_resolves_save_book_view(self):
        book_id = 1
        url = reverse("save-book", kwargs={"book_id": book_id})

        self.assertEqual(resolve(url).func.__name__, views.save_book.__name__)

    def test_resolves_author_create_view(self):
